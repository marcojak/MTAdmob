...
namespace Android.Gms.Ads.Hack
{
        ...
        public unsafe static void Load(Context context, string adUnit, AdRequest request, AdLoadCallback callback)
        {
            ...
            try
            {
                ...
                *ptr = new JniArgumentValue(context?.Handle ?? IntPtr.Zero);
                ...
                _members.StaticMethods.InvokeVoidMethod(
                    "load.(Landroid/content/Context;Ljava/lang/String;Lcom/google/android/gms/ads/AdRequest;Lcom/google/android/gms/ads/interstitial/InterstitialAdLoadCallback;)V",
                    ptr);
            }
            finally
            {
    ...
    {
        private static readonly JniPeerMembers _members = new XAPeerMembers("com/google/android/gms/ads/interstitial/InterstitialAdLoadCallback",
            typeof(InterstitialAdLoadCallback));
        ...
        private static void n_onAdLoaded(IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
        {
            ...
            global::Android.Gms.Ads.Interstitial.InterstitialAd object2 =
                Java.Lang.Object.GetObject<global::Android.Gms.Ads.Interstitial.InterstitialAd>(native_p0, JniHandleOwnership.DoNotTransfer);
        ...
        public unsafe static void Load(Context context, string adUnit, AdRequest request, RewardedAdLoadCallback callback)
        {
            ...
            try
            {
                ...
                *ptr = new JniArgumentValue(context?.Handle ?? IntPtr.Zero);
                ...
                ptr[3] = new JniArgumentValue(callback?.Handle ?? IntPtr.Zero);
                _members.StaticMethods.InvokeVoidMethod(
                    "load.(Landroid/content/Context;Ljava/lang/String;Lcom/google/android/gms/ads/AdRequest;Lcom/google/android/gms/ads/rewarded/RewardedAdLoadCallback;)V", ptr);
            }
            finally
            {
                JNIEnv.DeleteLocalRef(intPtr);
    ...
    public abstract class RewardedAdLoadCallback : AdLoadCallback
    {
        ...
        private static void n_onAdLoaded(IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
        {
            ...
            global::Android.Gms.Ads.Rewarded.RewardedAd object2 =
                Java.Lang.Object.GetObject<global::Android.Gms.Ads.Rewarded.RewardedAd>(native_p0, JniHandleOwnership.DoNotTransfer);
    ...
    public abstract class RewardedInterstitialAd : Java.Lang.Object
    {
        private static readonly JniPeerMembers _members = new XAPeerMembers("com/google/android/gms/ads/rewardedinterstitial/RewardedInterstitialAd",
            typeof(RewardedInterstitialAd));

        public unsafe static void Load(Context context, string adUnit, AdRequest request, RewardedInterstitialAdLoadCallback callback)
        {
            IntPtr intPtr = JNIEnv.NewString(adUnit);
            try
            {
                ...
                *ptr = new JniArgumentValue(context?.Handle ?? IntPtr.Zero);
                ...
                ptr[3] = new JniArgumentValue(callback?.Handle ?? IntPtr.Zero);
                _members.StaticMethods.InvokeVoidMethod(
                    "load.(Landroid/content/Context;Ljava/lang/String;Lcom/google/android/gms/ads/AdRequest;Lcom/google/android/gms/ads/rewardedinterstitial/RewardedInterstitialAdLoadCallback;)V",
                    ptr);
            }
            finally
            {
    ...
    [Register("com/google/android/gms/ads/rewardedinterstitial/RewardedInterstitialAdLoadCallback", DoNotGenerateAcw = true)]
    public abstract class RewardedInterstitialAdLoadCallback : AdLoadCallback
    {
        private static readonly JniPeerMembers _members = new XAPeerMembers("com/google/android/gms/ads/rewardedinterstitial/RewardedInterstitialAdLoadCallback",
            typeof(RewardedInterstitialAdLoadCallback));
        ...
        protected RewardedInterstitialAdLoadCallback(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        [Register(".ctor", "()V", "")]
        public unsafe RewardedInterstitialAdLoadCallback()
            : base(IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
        {
            if (!(base.Handle != IntPtr.Zero))
            {
        ...
        private static void n_onAdLoaded(IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
        {
            RewardedInterstitialAdLoadCallback? @object = Java.Lang.Object.GetObject<RewardedInterstitialAdLoadCallback>(jnienv, native__this, JniHandleOwnership.DoNotTransfer);
            global::Android.Gms.Ads.RewardedInterstitial.RewardedInterstitialAd object2 =
                Java.Lang.Object.GetObject<global::Android.Gms.Ads.RewardedInterstitial.RewardedInterstitialAd>(native_p0, JniHandleOwnership.DoNotTransfer);
        ...
        public virtual void OnRewardedInterstitialAdLoaded(global::Android.Gms.Ads.RewardedInterstitial.RewardedInterstitialAd rewardedAd)
        {
        }
    }
}